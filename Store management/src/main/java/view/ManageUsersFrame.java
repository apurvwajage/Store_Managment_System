...
public class ManageUsersFrame extends JFrame implements ActionListener {
    ...
    private final JLabel usernameLabel, fullNameLabel, passwordLabel, contactLabel, userAccessLevelLabel, instructionLabel;
    private final JTextField usernameTextField, fullNameTextField, passwordTextField, contactTextField;
    ...
    ManageUsersFrame() throws SQLException{
        ...
        setTextFieldDesign(contactLabel, contactTextField);
        ...
        tableColumns = new String[]{"Username",
                "Full name", "Password", "Contact", "Access Level"};
        ...
        userDataTable.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent event){
                if (event.getClickCount() == 2 && event.getButton() == MouseEvent.BUTTON1){
                    ...
                    contactTextField.setText((String) userData[userDataTable.getSelectedRow()][3]);
    ...
    private boolean isBoxesEmpty() {
        return (fullNameTextField.getText().isBlank() || usernameTextField.getText().isBlank()
                || passwordTextField.getText().isBlank() || contactTextField.getText().isBlank()
